...
function executeCallback(_original_id, _request_options, _data_payload) {
    return new Promise(function(resolve, reject) {
        ...
        var sqlInsert = "INSERT INTO wasm_execution_log (wasm_executable_id, execution_timestamp, execution_object) VALUES ('" + _original_id + "', NOW(), '" + JSON.stringify(JSON.parse(logging_object)) + "');";
