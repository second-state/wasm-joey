...
class ReadyAtZero {
    ...
    callback_has_executed() {
        this.callback_executed = true;
    }
}
/* Utils - END */
                            ...
                            if (!m_error) {
                                ...
                                while (true && in_progress == false) {
                                    if (readyAtZero.isReady() == true) {
                                        ...
                                        // Callback
                                        if (readyAtZero.callback_already_set == false && readyAtZero.callback_executed == false) {
